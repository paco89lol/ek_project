...
function allGroup() {
    ...
    foreach ($arrObj as $group) {
      ...
      <a data-original-title="Delete" onclick="initDeleteGroup(\''.$accountId.'\',\''.$group->id.'\')" style="overflow: hidden; position: relative;" href="#pop_up_delete_group" data-toggle="modal" class="btn btn-effect-ripple btn-xs btn-danger"><i class="fa fa-times"></i></a>
      </span>';
        $addGroup .= '</p>'."\n";
